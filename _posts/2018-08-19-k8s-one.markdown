...
![k8s cluster](_image/k8s/k8s_cluster.png)
...
![](_image/k8s_session_1/kubernetes-pod-life-cycle.jpg)
...
![](_image/k8s_session_1/single_pod.png)
...
![](_image/k8s_session_1/create_pod_process.png)
...
![](_image/k8s_session_1/replicaset.png)

Process of creating a ReplicaSet:

![](_image/k8s_session_1/rs_create_process.png)



Cluster View:

![](_image/k8s_session_1/rs_create_cluster_view.png)
